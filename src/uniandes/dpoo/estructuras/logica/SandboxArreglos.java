...
public class SandboxArreglos
{
    ...
    public void agregarEntero( int entero )
    {
    	...
    	this.arregloEnteros = Arrays.copyOf(this.arregloEnteros, N + 1);
    ...
    public void agregarCadena( String cadena )
    {
    	...
    	this.arregloCadenas = Arrays.copyOf(this.arregloCadenas, N + 1);
    ...
    public void eliminarEntero( int valor )
    {
        ...
        int posicionNuevoArreglo = 0;
        for (int j=0; j<=nuevoArreglo.length; j++) {
            if (nuevoArreglo[j] != valor) {
                nuevoArreglo[posicionNuevoArreglo] = nuevoArreglo[j];
                posicionNuevoArreglo++;
            }
        }
